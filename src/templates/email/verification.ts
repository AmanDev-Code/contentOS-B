...
export function getVerificationTemplate(otp: string): string {
  const content = `
    ...
    <p class="text">Thank you for signing up for Postra. Enter the code below to verify your email and access your dashboard.</p>
    ...
    <p class="text" style="font-size: 13px; color: #71717a;">If you did not create an account with Postra, you can safely ignore this email.</p>
  `;
  return wrapEmail(content, 'Verify Your Email - Postra');
}
